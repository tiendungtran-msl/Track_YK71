...
HD_PWD='D:/Nhung/FPGA/Track/Track.runs/test_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_mdm_1_0.tcl
