...
HD_PWD='D:/Nhung/FPGA/Track/Track.runs/test_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_axi_uartlite_0_0.tcl
