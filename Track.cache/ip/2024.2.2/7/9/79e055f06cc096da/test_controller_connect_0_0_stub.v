...
(* CHECK_LICENSE_TYPE = "test_controller_connect_0_0,controller_connect,{}" *) (* CORE_GENERATION_INFO = "test_controller_connect_0_0,controller_connect,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=controller_connect,x_ipVersion=1.0,x_ipCoreRevision=5,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4,C_S_AXI_INTR_DATA_WIDTH=32,C_S_AXI_INTR_ADDR_WIDTH=5,C_NUM_OF_INTR=1,C_INTR_SENSITIVITY=0xFFFFFFFF,C_INTR_ACTIVE_STATE=0xFFFFFFFF,C_IRQ_SENSITIVITY=1,C_IRQ_ACTIVE_STATE=1}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(error, has_signal, spd_width, r0_YB, 
  ...
  s00_axi_rready, s_axi_intr_aclk, s_axi_intr_aresetn, s_axi_intr_awaddr, 
