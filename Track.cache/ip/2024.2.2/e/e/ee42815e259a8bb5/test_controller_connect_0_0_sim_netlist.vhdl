...
\s00_axi_rdata[3]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => sel0(2),
      I3 => slv_reg4(3),
      I4 => \s00_axi_rdata[3]_INST_0_i_1_n_0\,
      O => s00_axi_rdata(3)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller_core is
  ...
  signal \irq_stretch_cnt[2]_i_1_n_0\ : STD_LOGIC;
  signal \irq_stretch_cnt[3]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[7]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \dbg_irq_evt_cnt[7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[2]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \dbg_r0_rise_cnt[7]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \irq_stretch_cnt[0]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \irq_stretch_cnt[4]_i_2\ : label is "soft_lutpair14";
begin
...
\dbg_irq_evt_cnt[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
      I0 => \^core_status_1\(14),
      I1 => \^core_status_1\(12),
      I2 => \dbg_irq_evt_cnt[7]_i_3_n_0\,
      I3 => \^core_status_1\(13),
      O => \p_0_in__1\(6)
    );
\dbg_irq_evt_cnt[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2AAAAAAAAAAAAAAA"
    )
        port map (
      I0 => \irq_stretch_cnt[4]_i_2_n_0\,
      I1 => \^core_status_1\(13),
      I2 => \^core_status_1\(12),
      I3 => \^core_status_1\(15),
      I4 => \^core_status_1\(14),
      I5 => \dbg_irq_evt_cnt[7]_i_3_n_0\,
      O => dbg_irq_evt_cnt
    );
\dbg_irq_evt_cnt[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
\dbg_irq_evt_cnt[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\dbg_r0_rise_cnt[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
      I0 => \^core_status_1\(6),
      I1 => \^core_status_1\(4),
      I2 => \dbg_r0_rise_cnt[7]_i_3_n_0\,
      I3 => \^core_status_1\(5),
      O => \p_0_in__0\(6)
    );
\dbg_r0_rise_cnt[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2AAAAAAAAAAAAAAA"
    )
        port map (
      ...
      I3 => \^core_status_1\(7),
      I4 => \^core_status_1\(6),
      I5 => \dbg_r0_rise_cnt[7]_i_3_n_0\,
      O => dbg_r0_rise_cnt
    );
\dbg_r0_rise_cnt[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
\dbg_r0_rise_cnt[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\irq_stretch_cnt[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
