...
`timescale 1 ns / 1 ps
	...
	(
        ...
        output wire [2:0]  mode,          // Xuất ra khối sync
		// User ports ends
	...
	controller_connect_slave_lite_v1_0_S00_AXI # ( 
...
// Instantiation of Axi Bus Interface S_AXI_INTR
	controller_connect_slave_lite_inter_v1_0_S_AXI_INTR # ( 
	...
	) controller_connect_slave_lite_inter_v1_0_S_AXI_INTR_inst (
    ...
    // Khởi tạo khối Core chứa logic nghiệp vụ
    controller_core core_inst (
        .clk(s00_axi_aclk),
        ...
        .core_irq(core_irq_out)
    );

	// Route trực tiếp IRQ từ core (theo sườn r0_YB).
	// S_AXI_INTR vẫn giữ để tương thích cổng AXI nhưng không lái chân irq.
	assign irq = core_irq_out;
