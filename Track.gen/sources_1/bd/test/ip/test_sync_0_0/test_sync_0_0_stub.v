...
(* CHECK_LICENSE_TYPE = "test_sync_0_0,sync,{}" *) (* CORE_GENERATION_INFO = "test_sync_0_0,sync,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=sync,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,PULSE_HIGH_CYCLES=280,PERIOD_CYCLES=112000,PERIOD_SMALL_CYCLES=56000,PERIOD_FAST_T1_CYCLES=54400,PERIOD_FAST_T2_CYCLES=57600,PERIOD_SLOW_T1_CYCLES=50400,PERIOD_SLOW_T2_CYCLES=61600}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "sync,Vivado 2024.2.2" *) 
module test_sync_0_0(clk, rst_n, mode, r0_YB)
/* synthesis syn_black_box black_box_pad_pin="rst_n,mode[2:0],r0_YB" */
