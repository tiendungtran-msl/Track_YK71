...
#ifndef _test_microblaze_0_xlconcat_0_core_h_
#define _test_microblaze_0_xlconcat_0_core_h_
...
class test_microblaze_0_xlconcat_0_core : public sc_module 
{
    public: 
       test_microblaze_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(test_microblaze_0_xlconcat_0_core);
        SC_METHOD(concate_input_port_values);
            sensitive << In0 ;
        dont_initialize();
    }

    virtual ~test_microblaze_0_xlconcat_0_core() = default;
   
    void concate_input_port_values()
    {
        sc_bv <1> portConcateVal;
