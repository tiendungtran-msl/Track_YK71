...
#
# Script generated by Vivado on Thu May 07 10:13:35 +0700 2026
...
#
# Usage        : test.sh
#                test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test.sh [-reset_run]
#                test.sh [-reset_log]
#                test.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L smartconnect_v1_0 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "test.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L microblaze_v11_0_14 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_10 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_20 -L xlconcat_v2_1_6 -L mdm_v3_2_27 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_register_slice_v2_1_34 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot test xil_defaultlib.test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test -key {Behavioral:sim_1:Functional:test} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e50.protoinst" -protoinst "protoinst_files/test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test.wdb xsim.dir libdpi.so)
...
Usage: test.sh [-reset_log]\n\
Usage: test.sh [-keep_index]\n\
