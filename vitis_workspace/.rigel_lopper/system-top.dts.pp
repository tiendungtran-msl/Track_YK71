# 0 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "test_wrapper.bit.bin";
  clocking0: clocking0 {
...
# 4 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
  xlnx,i-cache-size = <0x8000>;
  xlnx,d-cache-line-size = <20>;
  xlnx,i-cache-line-size = <20>;
  xlnx,cpu-1x-clk-freq-hz = <83333336>;
 ...
 &i2c0 {
  ...
  status = "okay";
  xlnx,clock-freq = <83333336>;
  xlnx,i2c-clk-freq-hz = <83333336>;
 ...
 &can0 {
  ...
  xlnx,ip-name = "ps7_can";
  xlnx,name = "ps7_can_0";
 };
 &ttc0 {
  xlnx,rable = <0>;
  xlnx,ttc-clk2-freq-hz = <83333336>;
  xlnx,ttc-clk1-clksrc = <0>;
  status = "okay";
  xlnx,clock-freq = <83333336>;
  xlnx,ttc-clk2-clksrc = <0>;
  xlnx,ip-name = "ps7_ttc";
  xlnx,ttc-clk0-freq-hz = <83333336>;
  xlnx,ttc-clk1-freq-hz = <83333336>;
...
# 5 "D:\\Nhung\\FPGA\\Track\\vitis_workspace\\Track_platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "mys-7z020";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0xe0008000 &can0 0xe0008000 0x1000>,
